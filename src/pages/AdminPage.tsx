...
export const AdminPage = () => {
  ...
  const revokeMember = async () => {
    ...
    try {
      ...
      actions.updateMember(member.id, { status: 'revoked' });
      setRevokeId(null);
    } catch (reason) {
